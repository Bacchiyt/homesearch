...
- Phase 1 now includes the Python 3.14/uv bootstrap, strict versioned configuration loading, and configuration schema version 2's explicit one-user/default-user anchor. Source/search policy sections, persistence, migrations, Compose, and CI remain unimplemented.

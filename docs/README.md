...
- Phase 1 now includes the Python 3.14/uv bootstrap, strict versioned configuration loading, the explicit one-user/default-user anchor, and configuration schema version 3's empty-by-default source-policy registry. Search definitions, persistence, migrations, Compose, and CI remain unimplemented.
